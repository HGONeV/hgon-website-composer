...
function user_decodeSpURL_preProc(&$params, &$ref) {
    $params['URL'] = str_replace('event/', 'detail/tx-rkw-events/', $params['URL']);
    $params['URL'] = str_replace('standort/', 'detail/tx-hgon-workgroup/', $params['URL']);
    $params['URL'] = str_replace('aktuelles/', 'detail/tx-news/detail/News/', $params['URL']);
}

function user_encodeSpURL_postProc(&$params, &$ref) {
    $params['URL'] = str_replace('detail/tx-rkw-events/', 'event/', $params['URL']);
    $params['URL'] = str_replace('detail/tx-hgon-workgroup/', 'standort/', $params['URL']);
