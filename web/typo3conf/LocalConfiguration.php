...
return [
    'BE' => [
        ...
        'installToolPassword' => '$P$CFDqud/ABZV/uO1y9yfSj1xYMkK.qs1',
        'lockSSL' => '1',
        'loginSecurityLevel' => 'rsa',
        'sessionTimeout' => '36000',
        'versionNumberInFilename' => '0',
        'warning_email_addr' => 'admin@rkw.de',
    ],
    'DB' => [
        'database' => '',
    ...
    'SYS' => [
        ...
        'cookieDomain' => '/\\.(rkw\\.de)|(www\\.rkw-kompetenzzentrum\\.de)|(wepstra-app\\.rkw-kompetenzzentrum\\.de)|(websitecheck\\.rkw-kompetenzzentrum\\.de)|(rkw-sachsenanhalt\\.de)$/',
        'cookieSecure' => '2',
        'curlUse' => '1',
        'devIPmask' => '',
        'displayErrors' => 0,
        ...
        'systemLog' => 'mail,webmaster@vm1.rkw.de,3',
        'systemLogLevel' => 2,
        't3lib_cs_convMethod' => 'mbstring',
        't3lib_cs_utils' => 'mbstring',
        'trustedHostsPattern' => '(.*\\.rkw\\.de|.*\\.rkw-kompetenzzentrum\\.de|.*\\.rkw-sachsenanhalt\\.de|.*\\.rkw-thueringen\\.de|.*\\.frauenambau\\.de|.*\\.ressinnobau\\.de|.*\\.karriereseiten-check\\.de|.*\\.digitalisierungs-cockpit\\.de|.*\\.eanpc\\.eu|.*\\.aprodi-projekt\\.de|.*\\.baumitbim\\.de)',
    ],
];
